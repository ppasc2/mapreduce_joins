...
public class JoinMapper extends Mapper<LongWritable, Text, Text, TuplePair> {
  ...
  public static final int CUSTOMERS_JOINKEY_IND = 1;
  public static final int ORDERS_JOINKEY_IND = 2;
  public void map(LongWritable key, Text value, Context context)
    ...
    if (fileName.equals("customers.txt")) {
      outValue.setRelationName("customers");
      joinIndex = CUSTOMERS_JOINKEY_IND;
    } else {
      outValue.setRelationName("orders.txt");
      joinIndex = ORDERS_JOINKEY_IND;}
